...
const Section2:React.FC = () => (
  <Fd dur={138} fi={10} fo={1}>
    <Safe style={{flexDirection:'row', gap:140, justifyContent:'center'}}>
      <IconItem 
        icon={<TrendingUp size={90} color={C.accent} strokeWidth={2}/>} 
        label="CTR" 
        accent={C.accent} 
        d={0} 
      />
      <IconItem 
        icon={<Target size={90} color={C.orange} strokeWidth={2}/>} 
        label="CPA" 
        accent={C.orange} 
        d={15} 
      />
      <IconItem 
        icon={<DollarSign size={90} color={C.purple} strokeWidth={2}/>} 
        label="ROAS" 
        accent={C.purple} 
        d={30} 
      />
...
export const M1Icons062604V1:React.FC = () => {
  return (
