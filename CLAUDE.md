...
2. **Recargar / Actualizar** — recarga el panel y verifica actualizaciones vía GitHub API. Muestra la versión actual (`v2.5.3`); cuando hay una actualización disponible muestra la transición pulsante (p.ej. `v2.5.2 → v2.5.3`).
...
- La versión vive en el archivo `VERSION` (actual: **2.5.3**) y en `CSXS/manifest.xml`.
