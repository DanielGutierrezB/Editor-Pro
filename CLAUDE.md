...
2. **Recargar / Actualizar** — recarga el panel y verifica actualizaciones vía GitHub API. Muestra la versión actual (`v2.5.2`); cuando hay una actualización disponible muestra la transición pulsante (p.ej. `v2.5.1 → v2.5.2`).
...
- La versión vive en el archivo `VERSION` (actual: **2.5.2**) y en `CSXS/manifest.xml`.
