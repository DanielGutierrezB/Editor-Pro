...
2. **Recargar / Actualizar** — recarga el panel y verifica actualizaciones vía GitHub API. Muestra la versión actual (`v2.3.3`); cuando hay una actualización disponible muestra la transición pulsante (p.ej. `v2.3.2 → v2.3.3`).
...
- La versión vive en el archivo `VERSION` (actual: **2.3.3**) y en `CSXS/manifest.xml`.
