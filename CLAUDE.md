...
2. **Recargar / Actualizar** — recarga el panel y verifica actualizaciones vía GitHub API. Muestra la versión actual (`v2.4.1`); cuando hay una actualización disponible muestra la transición pulsante (p.ej. `v2.4.0 → v2.4.1`).
...
- La versión vive en el archivo `VERSION` (actual: **2.4.1**) y en `CSXS/manifest.xml`.
