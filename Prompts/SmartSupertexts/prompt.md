...
- **bullet**: BULLET — Elemento de una lista o enumeración corta y continua. REGLA ABSOLUTA: un bullet NUNCA puede estar solo. Si al generar el JSON un bullet no tiene al menos otro bullet con el mismo 'group' inmediatamente antes o después, CONVIÉRTELO en title. Revisa tu respuesta antes de enviarla: si algún group tiene un solo bullet, es un error — cámbialo a title. La lista debe ser continua y cercana en tiempo. Un buen bullet es corto. Si entre los conceptos hay mucho desarrollo, no son bullets: son títulos.
